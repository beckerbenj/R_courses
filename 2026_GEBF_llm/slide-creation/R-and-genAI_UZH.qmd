...
subtitle: "In times of Generative AI"
...
## Where can I find the slides? {.center}

<https://shorturl.at/0HVjw>
...
GenAI will replace (data) scientists and programmers in the near future.

![Source: xkcd; <https://www.explainxkcd.com/wiki/index.php/1668:_Singularity>](figures/xkcd_singularity.png){height=400}
...
-   GenAI will `not` replace (data) scientists and programmers in the near future![^1]
-   R/programming skills may become even more important in the future[^2]
-   GenAI can be a helpful programming/R learning tool [@lin2025facilitating; @nathaniel2025investigating]
...
# Who are your? - Wooclap

[click here](https://app.wooclap.com/AHQJDP?from=instruction-slide)

![](figures/qr_wooclap_uzh.jpg)
...
-   Quality of *prediction* depends on available data
...
-   (limited) Context window = what it remembers from a chat (your profile) (Retrieval-Augmented Generation?)
...
-   generate code for figures, preproccesing, functions, ...
...
-   is uncritical (especially for your questions)

-   is (over)eager and wants to please

. . . 

**Basic understanding of how it works is key for good use of GenAI**
...
> When the input is c("ffe-2026_grod", "lul_2001 spc", "cas-1994-upek") the 
  function should return a data.frame with these columns: 
>
>   type = c("ffe", "lul", "cas"),
> 
...
-   Through [ellmer](https://ellmer.tidyverse.org/) and RStudio (GenAI account required)

-   via the positron (vsCode) integration of github-copilot (GenAI account
    required)
...
[ellmer Illustration](https://users.ugent.be/~ddebeer/workshops/GEBF/ellmer-example/using-ellmer.html)
...
-   Via PositAI subscription

-   Other genAI models can be used, but a subscription (and `API_KEY`) is
    required
...
[Positron IDE](https://positron.posit.co/assets/images/positron-logo_fullcolor-TM.png)
...
-   Hallucinations/confabulations (providing incorrect answers confidently)

-   Rarely question the question (sycophancy)
...
## Risks when using GenAI for learning

Using GenAI in learning settings [@bernstein2025beyond] can harm:

- critical thinking (over reliance on output)

- acquiring knowledge (shallow learning, copy-paste)

- acquiring and applying skills (coding, problem-solving)

- acquiring meta-cognitive skills (planning, monitoring, and adapting)
...
-   Technological dependence/digital sovereignty 
...
How should automated driving be used in driving education? 
 ...
 - the automated driver functions correctly in 90% of the situations
 - in the other 5% the real driver is asked to to take control
...
## For using GenAI to improve R skills
...
Ask for feedback and improvements on your code.
...
Ask for alternative solutions to your code.
...
- look into books and courses

- experimenter mindset

- consult colleagues and peers (Stack overflow)
 



## Recommendations on GenAI for R-related stuff

- Use GenAI for what you could do yourself (efficiency gain + quality control)

- Consider the environmental impact (Is GenAI appropriate for this task?)

- Don't ask to repeat a task (ask to write code to repeat a task)

- Ask twice (in a new chat), than consult a colleague, a book,...

- Think about your prompt, but don't waste time with prompt optimization
...
- Be critical about the response 

- Be critical about your question! (cf. *carwash*)

- stay in charge (you cannot blame the "over eager intern")

- Consider your workflow/feeling of accomplishment. Automate (only) the tedious tasks
...
[^1]: Pareto Principle (<https://en.wikipedia.org/wiki/Pareto_principle>); and if it does we have other problems than obsolete R skills.

[^2]: Jevons paradox (<https://en.wikipedia.org/wiki/Jevons_paradox>)

[^3]: Reference: <https://www.youtube.com/watch?v=jC4v5AS4RIM>
