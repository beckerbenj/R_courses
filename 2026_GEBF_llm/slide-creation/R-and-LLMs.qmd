...
-   generate code for figures, preprosssing, functions, ...
...
-   Provides 
    ...
    -  automatic editing
    -  planning
    -  [databot](https://positron.posit.co/databot.html) but still [experimental](https://posit.co/blog/introducing-databot/) and with [a warning](https://posit.co/blog/databot-is-not-a-flotation-device/)
...
- consult colleagues and peers (Stackoverflow)
...
- Think about your prompt, but don't waist time with prompt optimization
...
- Be critical about your question! (*carwash*)

- stay in charge (you cannot blame the "intern")
