...
- AI will not replace (data) scientists and programmers in the near future
- R skills may become even more important in the future
- LLMs can be helpful R learning tools
- LLMs can be harmful to R learners
...
Reference: https://www.youtube.com/watch?v=jC4v5AS4RIM
