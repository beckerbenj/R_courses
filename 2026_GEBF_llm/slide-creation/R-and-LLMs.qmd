...
- AI will not replace (data) scientists and programmers in the near future![^6]
- R skills may become even more important in the future
- LLMs can be helpful R learning tools[^3],[^5]
- LLMs can be harmful to R learners[^4]

[^6]: And if it does we have other problems than worthless R skills.

[^3]: Lin, Y., Zhang, Y., Yang, Y., Pan, S., Ren, X., & Chen, D. (2025). Facilitating computational thinking with AI: A three-level meta-analytic evidence for future-ready learning. Thinking Skills and Creativity, 102070. https://doi.org/10.1016/j.tsc.2025.102070

[^5]: Nathaniel, J., Oyelere, S. S., Suhonen, J., & Tedre, M. (2025). Investigating the impact of Generative AI integration on the Sustenance of Higher-Order Thinking Skills and understanding of programming logic in Programming Education. Computers and Education: Artificial Intelligence, 100460. https://doi.org/10.1016/j.caeai.2025.100460

[^4]: Bernstein, S., Rahman, A., Sharifi, N., Terbish, A., & MacNeil, S. (2025, November). Beyond the Benefits: A Systematic Review of the Harms and Consequences of Generative AI in Computing Education. In Proceedings of the 25th Koli Calling International Conference on Computing Education Research (pp. 1-18).


## Our key message

It is very worthwhile acquiring actual R skills and you should be very conscious how you use LLMs for this purpose!
...
- 5 - I could do most things without an LLM, but repeatedly rely on LLMs
- 10 - I a completely lost without an LLM

## External perspective

You have a student helper you gave an R coding task (e.g., cleaning a data set and running some preliminary data analysis). They tell you they used AI heavily, how much do you trust them? How does your expectation change depending on how much they used AI? 
...
- Confabulations/hallucinations (providing incorrect answers confidently, see https://github.com/lechmazur/confabulations)
- (Confabulations: LLM does not know, tries to produce an answer anyway https://www.tandfonline.com/doi/abs/10.1076/jhin.7.3.225.1855)
...
- Privacy and confidentiality. Typically, research data should not be uploaded!
- Affects competencies and competency acquisition.
- Social inequality.

## Current issues

- Ecological consequences of LLM usage: [eco impact calculator](https://huggingface.co/spaces/genai-impact/ecologits-calculator)
