...
\begin{itemize}
  ...
  \item (Alternative) Reproducible Workflows
\end{itemize}
\textbf{Day 2}
\begin{itemize}
  \item RMarkdown
...
\textbf{Common threats (see also Peikert et al., 2021)}
\begin{itemize}
  \item Not runnable code (e.g., wrong code order)
...
Be able to ...
\begin{itemize}
  \item ... to reproduce your own research (i.e., analyses)
  \item ... publish your code openly with your research
  \item ... create reproducible research for others
...
% ----------------------------------------------------------------------------------------------------------------------
\section{Alternative Reproducible Workflows}
...
\begin{frame}{LaTeX vs. Markdown}
	...
	\end{itemize}
	\url{https://yihui.org/en/2013/10/markdown-or-latex/}
\end{frame}
...
\begin{frame}{LaTeX vs. Markdown}
	...
	\begin{itemize}
		\item More complex
		\item Sometimes complicated setup
...
\begin{frame}{Producing reproducible Word Tables via R}
	Different packages
	\begin{itemize}
		\item apaTables
		\item sjPlot
